        ...
        <form action="{{ route('admin.surveys.update', $survey) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="total_reward_coins" id="total_reward_coins" class="form-control" value="{{ old('total_reward_coins', $survey->total_reward_coins) }}" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $survey->is_active) == 1 ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" name="store_answers" id="store_answers" value="1" {{ old('store_answers', $survey->store_answers) == 1 ? 'checked' : '' }}>
            ...
            <div id="questions-container">
                @php
                    $existing = old('questions') ? old('questions') : $survey->questions->map(function($q){
                        return [
                            'question' => $q->question,
